...
function kPkmn(id){
  ...
  document.getElementById('pokehp0').innerHTML = `HP: ${pokeHp}`;
  let pokeAtk = karlStuff[id].stats[4].base_stat;
  document.getElementById('pokeattack0').innerHTML = `ATK: ${pokeAtk}`;
  let pokeDef = karlStuff[id].stats[3].base_stat;
  document.getElementById('pokedefense0').innerHTML = `DEF: ${pokeDef}`;
...
function bPkmn(id){
  ...
  document.getElementById('pokehp1').innerHTML = `HP: ${pokeHp}`;
  let pokeAtk = brianStuff[id].stats[4].base_stat;
  document.getElementById('pokeattack1').innerHTML = `ATK: ${pokeAtk}`;
  let pokeDef = brianStuff[id].stats[3].base_stat;
  document.getElementById('pokedefense1').innerHTML = `DEF: ${pokeDef}`;
...
function sPkmn(id){
  ...
  document.getElementById('pokehp2').innerHTML = `HP: ${pokeHp}`;
  let pokeAtk = stefStuff[id].stats[4].base_stat;
  document.getElementById('pokeattack2').innerHTML = `ATK: ${pokeAtk}`;
  let pokeDef = stefStuff[id].stats[3].base_stat;
  document.getElementById('pokedefense2').innerHTML = `DEF: ${pokeDef}`;
